document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchQuestions() {
        // CORRECCIÓN FINAL: Se usa la ruta relativa con el nombre 'preguntas.json' (todo en minúsculas)
    ...
    function checkAnswer(selectedButton, question) {
        ...
        // **CORRECCIÓN DE CASE-SENSITIVITY**
    ...
    function wildcard5050() {
        ...
        // Aseguramos que solo las incorrectas sean consideradas.
        const correctText = allQuestions[currentQuestionIndex].correctAnswer.trim().toLowerCase();
