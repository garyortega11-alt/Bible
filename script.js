...
const ui = {
    ...
    showPopup(message, type) {
        this.elements.promotionPopup.classList.remove('visible');
        this.elements.demotionPopup.classList.remove('visible');
        this.elements.promotionFailPopup.classList.remove('visible');

        if (type === 'promotion') {
            this.elements.promotionMessage.textContent = message;
            this.elements.promotionPopup.classList.add('visible');
        } else if (type === 'demotion') {
            this.elements.demotionMessage.textContent = message;
            this.elements.demotionPopup.classList.add('visible');
        } else if (type === 'promotion-fail') {
            this.elements.promotionFailMessage.textContent = message;
            this.elements.promotionFailPopup.classList.add('visible');
        }
    },
    showShieldEffect() {
        this.elements.shieldEffectPopup.classList.add('visible');
        setTimeout(() => {
            this.elements.shieldEffectPopup.classList.remove('visible');
        }, 1500); 
    },
    showNoNameError() {
        ...
        this.elements.nameErrorMsg.classList.add('visible');
    },
    showExitPopup() {
        gameActions.stopTimer();
        ...
        ui.elements.popupContainer.className = 'popup-overlay visible exit-popup';

        document.getElementById('saveExitBtn').addEventListener('click', () => {
            gameActions.saveProgress();
            ui.elements.popupContainer.classList.remove('visible');
    ...
    showNewGamePopup() {
        ...
        ui.elements.popupContainer.className = 'popup-overlay visible new-game-popup';
    ...
    showSettingsPopup() {
        ...
        ui.elements.popupContainer.className = 'popup-overlay visible settings-popup';
    ...
    endGame(message) {
        ...
        ui.elements.popupContainer.className = 'popup-overlay visible end-game-popup';
